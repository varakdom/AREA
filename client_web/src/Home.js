                                    ...
                                    <div key={key} style={{display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", padding: "5px 5px"}}>
                                        <div>
                                            ...
                                            <Button size="small" variant="contained" color="error" onClick={() => {
                                                Fetch(`https://api.zarea.fr/delete/${service}?id=${key}`, { method: "DELETE", credentials: "include", headers: {'Access-Control-Allow-Origin': '*','Access-Control-Allow-Headers': 'Content-Type'}, body: JSON.stringify(actions[service][key].params) }).then((result) => {
